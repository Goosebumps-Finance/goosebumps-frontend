...
const getFarmBaseTokenPrice = (
  ...
  if (farm.quoteToken.symbol === tokens(getChainId()).busd.symbol) {
    return hasTokenPriceVsQuote ? new BigNumber(farm.tokenPriceVsQuote) : BIG_ZERO
  }

  if (farm.quoteToken.symbol === tokens(getChainId()).wbnb.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === tokens(getChainId()).wbnb.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === tokens(getChainId()).busd.symbol) {
