        ...
        <div className="manage-area pt-100">
          <div className="container">
            <div className="section-title">
              ...
              <p>If you&apsop;re tired of using five different platforms to track your crypto invetments, then it&apsop;s time to meet Goosebumps.</p>
            </div>
              ...
              <div className="col-lg-4">
                <div className="manage-content">
                  <ul>
                    ...
                    <li>
                      <h3>
                        <img src="/images/goosebumps/portfolio-icon.png" alt="goosebumps" />
                        A sense of security that comes easy
                      </h3>
                      <p>We keep your data safe and never let you worry about data breaches or hacks. The best part? You can use the app with peace of mind - it&apsop;s completely free!
                      </p>
                    </li>
                  </ul>
                </div>
                ...
                <div className="manage-content">
                  <ul>
                    <li>
                      <h3>
                        <img src="/images/goosebumps/portfolio-icon.png" alt="goosebumps" />
                        A platform that&apsop;s built just for you
                      </h3>
                      <p>Whether you&apsop;re a beginner trader or a pro, Goosebumps has tools that are tailored for your needs. Stay on top of all your trades with features like portfolio management, news feed, alerts & more!
                      </p>
                    </li>
                    <li>
                      <h3 className="quick">
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="single-dex">
                  ...
                  <h3>Staking pools </h3>
                  <p>A staking pool allows you to pool your computational resources in order to increase chances of winning. Staking Pools offers its staking power in the process of verifying and validating new blocks, increasing the community&apsop;s chances of earning block rewards.</p>
                </div>
              </div>
