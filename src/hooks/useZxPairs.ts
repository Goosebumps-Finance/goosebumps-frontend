...
export function useZxPairs(currencies: [Currency | undefined, Currency | undefined][]): [PairState, Pair | null][] {
...
export function useZxPair(tokenA?: Currency, tokenB?: Currency): [PairState, Pair | null] {
  return useZxPairs([[tokenA, tokenB]])[0]
}
