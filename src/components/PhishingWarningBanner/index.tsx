...
import { Text, Flex, Box, CloseIcon, IconButton, useMatchBreakpoints } from '@goosebumps/uikit'
...
const PhishingWarningBanner: React.FC = () => {
  ...
  const warningText = t("please make sure you're visiting https://goosebumps.finance - check the URL carefully.")
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://goosebumps.finance'}
          color={text === 'https://goosebumps.finance' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
