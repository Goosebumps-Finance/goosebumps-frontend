...
export class DataPulseProvider {
  ...
  _requestsPending: number

  _historyProvider: any
  ...
  _updateData() {
    ...
    //             this._requestsPending -= 1;
    //             console.log(
    //                 `DataPulseProvider: data for #${listenerGuid} updated with error=${reason})}, pending=${this._requestsPending}`
    //             );
    //         });
    //     }
    // })
  ...
  _updateDataForSubscriber(listenerGuid) {
    ...
    console.log('data-pulse-provider _updateDataForSubscriber: rangeEndTime = ', rangeEndTime)
