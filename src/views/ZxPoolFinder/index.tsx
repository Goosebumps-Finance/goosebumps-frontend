...
import { PairState, useZxPair } from '../../hooks/useZxPairs'
...
export default function ZxPoolFinder() {
  ...
  const [pairState, pair] = useZxPair(currency0 ?? undefined, currency1 ?? undefined)
              ...
              hasPosition && pair ? (
                ...
                <LightCard padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    ...
                    <StyledInternalLink to={`/liquidityAdd/${currencyId(currency0)}/${currencyId(currency1)}`}>
