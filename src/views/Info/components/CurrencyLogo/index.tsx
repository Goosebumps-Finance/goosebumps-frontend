...
export const CurrencyLogo: React.FC<{
  ...
  const src = useMemo(() => {
    ...
    if(typeof checksummedAddress === 'string' && defaultTokenAddrs.includes(checksummedAddress)) {
      ...
      // return `https://goosebumps.finance/images/tokens/${defaultTokenAddrs[0]}.png`
      return `https://cryptosnowprince.com/images/tokens/${defaultTokenAddrs[0]}.png`
    }
    if (checksummedAddress) {
      // return `https://assets.trustwalletapp.com/blockchains/smartchain/assets/${checksummedAddress}/logo.png`
      // return `https://goosebumps.finance/images/tokens/${checksummedAddress}.png`
      return `https://cryptosnowprince.com/images/tokens/${checksummedAddress}.png`
    }
    return null
  }, [address])
