...
import { useZxPair } from 'hooks/useZxPairs'
...
export function useZxDerivedMintInfo(
  currencyA: Currency | undefined,
  currencyB: Currency | undefined,
): {
  dependentField: Field
  ...
  // pair
  const [pairState, pair] = useZxPair(currencies[Field.CURRENCY_A], currencies[Field.CURRENCY_B])
