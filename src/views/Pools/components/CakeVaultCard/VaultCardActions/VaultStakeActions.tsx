import { Button, Flex, Skeleton, useModal } from '@goosebumps/uikit'
...
const VaultStakeActions: React.FC<VaultStakeActionsProps> = ({
  ...
  const renderStakeAction = () => {
    return accountHasSharesStaked ? (
      ...
      <Button onClick={stakingTokenBalance.gt(0) ? onPresentStake : onPresentTokenRequired} variant="secondary">{t('Stake')}</Button>
    )
  }
