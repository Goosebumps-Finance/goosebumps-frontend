...
const { MAINNET, TESTNET, ETHEREUM, POLYGON } = ChainId
...
export const testnetTokens = defineTokens({
  ...
  mask: new Token(TESTNET, '0x2eD9a5C8C13b93955103B9a7C167B67Ef4d568a3', 18, 'MASK', 'Mask Token', 'https://mask.io/'),
  dvi: new Token(
    TESTNET,
    '0x758FB037A375F17c7e195CC634D77dA4F554255B',
    18,
  ...
  txl: new Token(TESTNET, '0x1FFD0b47127fdd4097E54521C9E2c7f0D66AafC5', 18, 'TXL', 'Tixl Token', 'https://tixl.org/'),
  orbs: new Token(
    TESTNET,
    '0xeBd49b26169e1b52c04cFd19FCf289405dF55F80',
    18,
  ...
  sxp: new Token(TESTNET, '0x47BEAd2563dCBf3bF2c9407fEa4dC236fAbA485A', 18, 'SXP', 'Swipe Token', 'https://swipe.io/'),
  alpha: new Token(
    TESTNET,
    '0xa1faa113cbE53436Df28FF0aEe54275c13B40975',
    18,
  ...
  xvs: new Token(TESTNET, '0xcF6BB5389c92Bdda8a3747Ddb454cB7a64626C63', 18, 'XVS', 'Venus Token', 'https://venus.io/'),
  sushi: new Token(
    TESTNET,
    '0x947950BcC74888a40Ffa2593C5798F11Fc9124C4',
    18,
  ...
  oddz: new Token(TESTNET, '0xCD40F2670CF58720b694968698A5514e924F742d', 18, 'ODDZ', 'Oddz Token', 'https://oddz.fi/'),
  hoo: new Token(TESTNET, '0xE1d1F66215998786110Ba0102ef558b22224C016', 8, 'HOO', 'Hoo Token', 'https://hoo.com/'),
  apys: new Token(
    TESTNET,
    '0x37dfACfaeDA801437Ff648A1559d73f4C40aAcb7',
    18,
  ...
  cyc: new Token(TESTNET, '0x810EE35443639348aDbbC467b33310d2AB43c168', 18, 'CYC', 'CYC Token', 'https://cyclone.xyz/'),
  chr: new Token(
    TESTNET,
    '0xf9CeC8d50f6c8ad3Fb6dcCEC577e05aA32B224FE',
    6,
  ...
  mx: new Token(TESTNET, '0x9F882567A62a5560d147d64871776EeA72Df41D3', 18, 'MX', 'MX Token', 'https://www.mxc.com/'),
  ata: new Token(
    TESTNET,
    '0xA2120b9e674d3fC3875f415A7DF52e382F141225',
    18,
  ...
  hai: new Token(TESTNET, '0xaA9E582e5751d703F85912903bacADdFed26484C', 8, 'HAI', 'Hacken Token', 'https://hacken.io/'),
  htb: new Token(
    TESTNET,
    '0x4e840AADD28DA189B9906674B4Afcb77C128d9ea',
    18,
  ...
  arv: new Token(TESTNET, '0x6679eB24F59dFe111864AEc72B443d1Da666B360', 8, 'ARV', 'ARIVA', 'https://ariva.digital'),
  moni: new Token(
    TESTNET,
    '0x9573c88aE3e37508f87649f87c4dd5373C9F31e0',
    18,
  ...
  qi: new Token(TESTNET, '0x8729438EB15e2C8B576fCc6AeCdA6A148776C0F5', 18, 'QI', 'BENQI', 'https://benqi.fi/'),
  sheesha: new Token(
    TESTNET,
    '0x232FB065D9d24c34708eeDbF03724f2e95ABE768',
    18,
  ...
  htd: new Token(TESTNET, '0x5E2689412Fae5c29BD575fbe1d5C1CD1e0622A8f', 18, 'HTD', 'HeroesTD', 'https://heroestd.io/'),
  dpt: new Token(
    TESTNET,
    '0xE69cAef10A488D7AF31Da46c89154d025546e990',
    18,
  ...
  antex: new Token(TESTNET, '0xCA1aCAB14e85F30996aC83c64fF93Ded7586977C', 8, 'ANTEX', 'Antex', 'https://antex.org/'),
  bbt: new Token(
    TESTNET,
    '0xD48474E7444727bF500a32D5AbE01943f3A59A64',
    8,
...
export const tokens = (chainId: ChainId) => {
...
type SerializedTokenList = Record<keyof typeof mainnetTokens, SerializedToken>

export const serializeTokens = (chainId: ChainId) => {
  const serializedTokens = Object.keys(unserializedTokens(chainId)).reduce((accum, key) => {
    return { ...accum, [key]: serializeToken(unserializedTokens(chainId)[key]) }
