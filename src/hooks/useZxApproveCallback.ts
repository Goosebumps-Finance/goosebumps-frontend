...
export function useZxApproveCallback(
...
// wraps useZxApproveCallback in the context of a swap
export function useZxApproveCallbackFromTrade(trade?: Trade, allowedSlippage = 0) {
  ...
  return useZxApproveCallback(amountToApprove, isSupportedChainId(chainId) ? ZX_ROUTER_ADDRESS[chainId] : undefined)
}
