...
import { Skeleton, Text, useTooltip, HelpIcon, Flex, Box, useMatchBreakpoints } from '@goosebumps/uikit'
...
const AutoEarningsCell: React.FC<AutoEarningsCellProps> = ({ pool, account }) => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Balance fontSize="16px" value={autoCakeToDisplay} decimals={3} bold unit=" Goose" />
            ...
            <Flex>
              <Box mr="8px" height="32px">
                <Balance
                  ...
                  color={hasEarnings ? 'primary' : 'textSubtle'}
